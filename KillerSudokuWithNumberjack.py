...
def defineModuleAndSudokuGrid(exampleCages):
    N = 3
    cagesList = parseCagesList(exampleCages)
...
def solve(exampleCages):
    sudokuGrid, model = defineModuleAndSudokuGrid(exampleCages)

    # solver = model.load("Mistral")
    solver = SourceFileLoader("_Mistral", "/usr/local/lib/python3.9/dist-packages/Numberjack/solvers/Mistral.py").load_module()
